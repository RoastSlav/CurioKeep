...
public class CollectionMemberEntity {
    ...
    public java.util.UUID getUserId() { return id != null ? id.getUserId() : null; }

    // getters/setters
    public CollectionMemberId getId() { return id; }
    public void setId(CollectionMemberId id) { this.id = id; }

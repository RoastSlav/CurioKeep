...
public class ModuleFieldEntity {
    ...
    public JsonNode getEnumValues() { return enumValues; }
    public void setEnumValues(JsonNode enumValues) { this.enumValues = enumValues; }
    public JsonNode getProviderMappings() { return providerMappings; }
    public void setProviderMappings(JsonNode providerMappings) { this.providerMappings = providerMappings; }
